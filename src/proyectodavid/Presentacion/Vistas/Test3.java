 ...
 * @author jorgerueda
 */
public class Test3 extends javax.swing.JFrame implements Vista, Observer {

    /**
     * Creates new form Test
     */
    public Test3(Usuario usr, boolean correccion) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Test3(null,false).setVisible(true);
