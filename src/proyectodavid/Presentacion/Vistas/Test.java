 ...
 * @author jorgerueda
 */
public class Test extends javax.swing.JFrame implements Vista, Observer {
 Dimension dim=super.getToolkit().getScreenSize();
    /**
     * Creates new form Test
     */
    public Test(Usuario usr, boolean correccion) {
       //initComponents();
               
        dim=GraphicsEnvironment.getLocalGraphicsEnvironment().getMaximumWindowBounds().getSize();
    ...
    private void initComponentsPlano(){
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(D, javax.swing.GroupLayout.DEFAULT_SIZE, 77, Short.MAX_VALUE)
                .addGap(10, 10, 10))
        );
        ...
        jButtonSaltar.setText("Saltar Categoria");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(jPanelConFondo1, javax.swing.GroupLayout.PREFERRED_SIZE, 613, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jPanelConFondo1, javax.swing.GroupLayout.DEFAULT_SIZE, 479, Short.MAX_VALUE)
                    .addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(33, 33, 33)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jButtonAnteriorPreguntaSin)
    ...
    private void initComponents() {
        ...
        C.setBackground(new java.awt.Color(245, 245, 245));
        buttonGroup1.add(C);
        C.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        C.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CActionPerformed(evt);
            }
        ...
        jTextAreaPregunta.setBackground(new java.awt.Color(255, 0, 0));
        jTextAreaPregunta.setColumns(20);
        jTextAreaPregunta.setFont(new java.awt.Font("Lucida Grande", 0, 15)); // NOI18N
        jTextAreaPregunta.setLineWrap(true);
        jTextAreaPregunta.setRows(5);
        jTextAreaPregunta.setWrapStyleWord(true);
        jTextAreaPregunta.setAutoscrolls(false);
    ...
    private void jButtonPreguntaSinContestarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPreguntaSinContestarActionPerformed
       indexPregunta=indexPrimera+(this.totalPreguntas-1);
       this.numPregunta=this.totalPreguntas;
       actualizar(-2,null);
    ...
    private void jButtonSaltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaltarActionPerformed
        int respuesta= JOptionPane.showConfirmDialog(null, "Si salta la categoría la prueba quedará suspensa. ¿Seguro que desea continuar?", "Confirmar Saltar Categoría", JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE);
        if(respuesta==JOptionPane.OK_OPTION){
        pararCrono();
        calcularPuntuacion(false);
    ...
    private void borrarTodo(String categoria){
        ...
        this.remove(this.jButtonSaltar);
        this.removeAll();*/
        ...
        switch (categoria) {
               ...
               case "PLANOS":
                   ...
                   break;
               case "ITINERARIOS":
                   this.initComponentsNormal();
                  // this.setSize(dim);
                   this.repaint();
                   break;
               case "CENTROS DE INTERES":
                   this.initComponentsNormal();
                  // this.setSize(dim);
                   this.repaint();
                   break;
    ...
    private void jLabelUserMouseClicked(java.awt.event.MouseEvent evt) {                                        
    ...
    private void iniciarCrono(int limit){
        ...
        crono = new Cronometro(jTextField2,limit);
        crono.addObserver(this);
        StopWatch stopwatch = new StopWatch(jTextField3,limit);
        if (limit <10){
             jTextField1.setText("00:"+"0"+String.valueOf(limit)+":00");
        }else{
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Test(null,false).setVisible(true);
    ...
    public void calcularPuntuacion(boolean salto){
        int index=indexPrimera;
        double puntuacion=0;
        int contestadas=0;
        int aciertos=0;
        Categoria cat=listaPreguntas.get(index).getIdPregunta().getCategoria();
        if(salto){
       ...
       Estadistica es= new Estadistica (user,cat,aciertos,contestadas);
       SAEstadistica servicioEstadistica = FactoriaSA.getInstancia().generaSAEstadistica();
       servicioEstadistica.altaEstadistica(es);
    }
    ...
    private Boolean calcularPuntuacionFinal(){
     ...
     public void reset(Usuario usr, Boolean correccion){
       ...
       //mientras no se llega a la ultima categoria, se avanza////
        ...
        this.borrarTodo(listaPreguntas.get(indexPrimera).getIdPregunta().getCategoria().getNombre());
        ...
        this.jTextFieldPreguntasTotales.setText(String.valueOf(this.totalPreguntas));
             ...
             if (indexPregunta< totalPreguntas-1)  {  
              ...
              if(listaPreguntas.get(indexPregunta).getIdPregunta().getCategoria().getNombre().equalsIgnoreCase(listaPreguntas.get(indexPregunta-1).getIdPregunta().getCategoria().getNombre())){
                  ...
                  numPregunta=1;
                  this.borrarTodo(listaPreguntas.get(indexPregunta).getIdPregunta().getCategoria().getNombre());
    ...
    public int numeroContestadas(String categoria){
     ...
     private void initComponentsNormal(){
      ...
      buttonGroup1 = new proyectodavid.Presentacion.NoneSelectedButtonGroup();
        ...
        jPanelConFondo1.setBackground(new java.awt.Color(255, 255, 255));
        jPanelConFondo1.setToolTipText("");
        jPanelConFondo1.setEnabled(false);
        jPanelConFondo1.setFocusable(false);
        jPanelConFondo1.setMinimumSize(new java.awt.Dimension(649, 459));
        jPanelConFondo1.setPreferredSize(new java.awt.Dimension(649, 459));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jPanelConFondo1, javax.swing.GroupLayout.PREFERRED_SIZE, 0, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(A, javax.swing.GroupLayout.DEFAULT_SIZE, 88, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
     ...
     private void initComponentsPsico(){
           buttonGroup1 = new proyectodavid.Presentacion.NoneSelectedButtonGroup();
        jPanel1 = new javax.swing.JPanel();
        A = new javax.swing.JToggleButton();
        C = new javax.swing.JToggleButton();
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jPanelConFondo1, javax.swing.GroupLayout.PREFERRED_SIZE, 112, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
