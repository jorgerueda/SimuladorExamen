 ...
 * @author jorgerueda
 */
public class ComandoAgregarExamen extends Comando {
    ...
    public RetornoComando execute() {
      int id;
		...
		if(id == 1){
			respuestaComando = new RetornoComando(EventoVista.AGREGAR_EXAMEN_EXITO,id); //crea la respuesta de comando
		}
		else {
			respuestaComando = new RetornoComando(EventoVista.AGREGAR_EXAMEN_FALLO,id); //crea la respuesta de comando
		}
