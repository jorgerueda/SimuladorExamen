 ...
 * @author jorgerueda
 */
public class ComandoEditarPregunta extends Comando{
    ...
    public RetornoComando execute() {
      int id;
		...
		id = servicioPregunta.editarPregunta(pregunta);
		
		RetornoComando respuestaComando;

		if(id == 1){
			respuestaComando = new RetornoComando(EventoVista.MODIFICAR_PREGUNTA_EXITO,id); //crea la respuesta de comando
		}
		else {
			respuestaComando = new RetornoComando(EventoVista.MODIFICAR_PREGUNTA_FALLO,id); //crea la respuesta de comando
		}
